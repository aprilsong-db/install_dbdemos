...
# MAGIC To run this demo, just select the cluster `dbdemos-llm-rag-chatbot-april_song` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/0310-200522-5gwx771n/configuration)). <br />
